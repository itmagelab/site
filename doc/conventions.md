...
### Минимализм и простота кода

- **ЗАПРЕЩЕНО** писать лишний код, который не требуется в задаче
- **ЗАПРЕЩЕНО** добавлять примеры, демонстрационный функционал или "фичи для удобства" без явного требования
- **ОБЯЗАТЕЛЬНО** реализовывать только то, что указано в требованиях
- **ЗАПРЕЩЕНО** добавлять UI элементы (кнопки, панели, переключатели) если это не указано в задаче
- **ОБЯЗАТЕЛЬНО** следовать принципу YAGNI (You Aren't Gonna Need It)
- **ЗАПРЕЩЕНО** "улучшать" функционал по собственной инициативе
